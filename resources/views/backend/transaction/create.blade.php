            ...
            <form action="{{route('transaction.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="customer_id" class="form-control" value="{{$data->id}}" required="">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label>Customer</label>
                            <input type="hidden" name="customer_id" class="form-control datepicker" value="{{$data->id}}" required="">
                            <input type="text" name="name" class="form-control datepicker" value="{{$data->name}}" required="" disabled>
                        </div>
                    </div>
                </div>
                @endif
